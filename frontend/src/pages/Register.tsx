...
const useStyles = makeStyles((theme) => ({
  ...
  inputRoot: {
    "& .MuiOutlinedInput-root": {
      ...
      "&.Mui-focused fieldset": { border: "2px solid #a8dadc" },
    },
...
const Register: React.FC<RegisterProps> = ({ setView, setAlerta }) => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    setAlerta({ open: true, msg: "Conta criada com sucesso!", severity: "success" });
    setLoading(false);
    setView("vagas");
  };
        ...
        <Grid item xs={12} md={6} className={classes.rightPanel}>
          ...
          <Box className={classes.formContainer}>
            ...
            <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <TextField
                fullWidth
                placeholder="Digite sua senha (mín. 6 chars)"
                variant="outlined"
                value={password}
